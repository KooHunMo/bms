	  ...
	  <c:choose>
		...
		<c:otherwise>
			<li>
				<h3>목록 보기</h3>
				<ul>
					<li><a href="${contextPath}/goods/goodsBestSeller.do">베스트셀러</a></li>
					<li><a href="${contextPath}/goods/goodsSteadySeller.do">스테디셀러</a></li>
					<li><a href="${contextPath}/goods/goodsNewBook.do">신간</a></li>
				</ul>
			</li>
			<br><br><br>
		 </c:otherwise>
